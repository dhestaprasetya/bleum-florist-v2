...
const waUrl = (name) => `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(name ? `Halo Bleum.Flowers BSD, saya tertarik dengan produk ${name}. Apakah produk ini masih tersedia?` : 'Halo Bleum.Flowers BSD, saya ingin berkonsultasi mengenai pilihan bouquet.')}`;
...
renderProducts();updateNavigation();
